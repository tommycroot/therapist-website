const Contact = () => {
    return (
        <div className="contact">
            <h1>Contact</h1>
            <p className="contact-p">If you’re considering therapy but aren’t sure where to begin, reaching out can be the first step.<br></br><br></br>You’re welcome to get in touch to: </p>
            <ul className="contact-list">
                <li>Book a free 30-minute phone call
                    <li>Arrange your first session</li>
